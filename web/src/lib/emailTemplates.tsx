...
export function templateMemberAccepted({
  companyName = APP_NAME,
  url,
}: ConfirmEmailProps) {
  return (
              ...
              <Section className="bg-bg mobile:px-2 px-6 py-4">
                ...
                <Section className="bg-bg-2 mobile:px-6 mobile:py-12 rounded-[8px] px-[40px] py-[64px] text-center">
                  <Section className="mb-3">
                    ...
                    />
                    <Heading as="h1" className="font-28 text-fg m-0 font-sans">
                      Your member status has been accepted
                    </Heading>
                  </Section>

                  <Text className="font-16 text-fg-2 mx-auto mb-8 mt-0 max-w-[380px] text-center font-sans">
                    Hi, your member status has been accepted, now you are a
                    player! Thank you for signing up for {companyName}.
                    <br />
                    To verify your account, we just need to confirm your email
                    address.
                  </Text>
