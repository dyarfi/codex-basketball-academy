        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="sm" mb="sm">
          ...
          >
            ...
            {isRosterAdded && (
              <>
                <Divider />
                <Stack align="stretch" justify="center" gap="sm" mt={'sm'}>
